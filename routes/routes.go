...
import (
	...
	"github.com/Gabriel-Rabeloo/go-rest-api/controllers"
	"github.com/Gabriel-Rabeloo/go-rest-api/middleware"
...
func HandleRequest() {
	...
	r.HandleFunc("/api/personalities/{id}", controllers.UpdatePersonality).Methods("Patch")
